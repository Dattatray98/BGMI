                    ...
                    <ScrollReveal key={index} delay={index * 0.1} className="h-full">
                        <Card className="card-hover border-zinc-800 bg-zinc-900/40 relative overflow-hidden group h-full">
                            ...
                            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                                <CardTitle className="text-xl font-bold tracking-wider text-zinc-100 group-hover:text-yellow-400 transition-colors">
                                    {item.title}
                                </CardTitle>
                                {item.icon}
                            </CardHeader>
                            <CardContent>
                                <div className="text-2xl font-bold text-zinc-300 font-teko tracking-wide">
                                    {item.value}
                                </div>
                            </CardContent>
                        </Card>
